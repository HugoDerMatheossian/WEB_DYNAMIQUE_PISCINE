...
--
-- Client :  127.0.0.1
-- Généré le :  Dim 30 Mai 2021 à 18:24
...
('DER MATHEOSSIAN Hugo', '28,rue Vauquelin', '4eme etage', 'Paris', 75005, 'France', 752625212, 'VISA', 2147483647, 'DER MATHEOSSIAN HUGO', '2023-03-01', 1234, 'TheBoss', 'dontask'),
('Henry Poste', '7, rue de la Guerre', 'sous-sol', 'Sarcelles', 95200, 'France', 689522356, 'VISA', 2147483647, 'HENRY POSTE', '2024-10-02', 1010, 'DarkSasukeX9', 'naruto');
